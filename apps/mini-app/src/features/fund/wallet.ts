 ...
 * Throws when no wallet is injected or the user rejects the prompt. In the
 * Telegram host the in-app browser may expose no wallet — callers must fall
 * back to saving the address unverified.
 */
