...
- Гость шлёт **одно** облачко на весь монолог (корень + продолжения автора), не набор фраз и не по одному на каждую мысль.
...
| `cloud.onePerSender` | Одно облачко на монолог×actor | unique thread_root + reject | QuietPhrases | live |
